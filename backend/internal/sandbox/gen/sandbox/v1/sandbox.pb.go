...
func (x *BrowserCookiesRequest) Reset() {
	*x = BrowserCookiesRequest{}
	mi := &file_sandbox_v1_sandbox_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BrowserCookiesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrowserCookiesRequest) ProtoMessage() {}

func (x *BrowserCookiesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sandbox_v1_sandbox_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrowserCookiesRequest.ProtoReflect.Descriptor instead.
func (*BrowserCookiesRequest) Descriptor() ([]byte, []int) {
	return file_sandbox_v1_sandbox_proto_rawDescGZIP(), []int{44}
}

func (x *BrowserCookiesRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *BrowserCookiesRequest) GetStateJson() string {
	if x != nil {
		return x.StateJson
	}
	return ""
...
func (x *BrowserCookiesRequest) GetApply() bool {
	if x != nil {
		return x.Apply
	}
	return false
...
func (x *BrowserCookiesResponse) Reset() {
	*x = BrowserCookiesResponse{}
	mi := &file_sandbox_v1_sandbox_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BrowserCookiesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrowserCookiesResponse) ProtoMessage() {}

func (x *BrowserCookiesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sandbox_v1_sandbox_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrowserCookiesResponse.ProtoReflect.Descriptor instead.
func (*BrowserCookiesResponse) Descriptor() ([]byte, []int) {
	return file_sandbox_v1_sandbox_proto_rawDescGZIP(), []int{45}
}

func (x *BrowserCookiesResponse) GetStateJson() string {
	if x != nil {
		return x.StateJson
	}
	return ""
...
const file_sandbox_v1_sandbox_proto_rawDesc = "" +
	...
	"\x15BrowserCookiesRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\x1d\n" +
	"\n" +
	"state_json\x18\x02 \x01(\tR\tstateJson\x12\x14\n" +
	"\x05apply\x18\x03 \x01(\bR\x05apply\"7\n" +
	"\x16BrowserCookiesResponse\x12\x1d\n" +
	"\n" +
	"state_json\x18\x01 \x01(\tR\tstateJson*L\n" +
	"\vContentType\x12\x1c\n" +
	"\x18CONTENT_TYPE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05MANGA\x10\x01\x12\t\n" +
	"\x05NOVEL\x10\x02\x12\t\n" +
	"\x05ANIME\x10\x032\xd3\n" +
	"\n" +
	"\x10ExtensionService\x12W\n" +
	"\x0eBrowserCookies\x12!.sandbox.v1.BrowserCookiesRequest\x1a\".sandbox.v1.BrowserCookiesResponse\x12N\n" +
...
var file_sandbox_v1_sandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_sandbox_v1_sandbox_proto_goTypes = []any{
	...
	(*BrowserCookiesRequest)(nil),        // 45: sandbox.v1.BrowserCookiesRequest
	(*BrowserCookiesResponse)(nil),       // 46: sandbox.v1.BrowserCookiesResponse
	nil,                                  // 47: sandbox.v1.StreamInfo.HeadersEntry
	nil,                                  // 48: sandbox.v1.VideoSource.HeadersEntry
}
var file_sandbox_v1_sandbox_proto_depIdxs = []int32{
	...
	47, // 9: sandbox.v1.StreamInfo.headers:type_name -> sandbox.v1.StreamInfo.HeadersEntry
	...
	48, // 13: sandbox.v1.VideoSource.headers:type_name -> sandbox.v1.VideoSource.HeadersEntry
	...
	45, // 27: sandbox.v1.ExtensionService.BrowserCookies:input_type -> sandbox.v1.BrowserCookiesRequest
	2,  // 28: sandbox.v1.ExtensionService.LoadExtensions:input_type -> sandbox.v1.LoadExtensionsRequest
	1,  // 29: sandbox.v1.ExtensionService.ListLoadedExtensions:input_type -> sandbox.v1.Empty
	4,  // 30: sandbox.v1.ExtensionService.UnloadExtension:input_type -> sandbox.v1.ExtensionRequest
	7,  // 31: sandbox.v1.ExtensionService.Search:input_type -> sandbox.v1.SearchRequest
	11, // 32: sandbox.v1.ExtensionService.GetDetails:input_type -> sandbox.v1.EntryRequest
	11, // 33: sandbox.v1.ExtensionService.GetChapters:input_type -> sandbox.v1.EntryRequest
	15, // 34: sandbox.v1.ExtensionService.GetPages:input_type -> sandbox.v1.ChapterRequest
	15, // 35: sandbox.v1.ExtensionService.GetChapterText:input_type -> sandbox.v1.ChapterRequest
	11, // 36: sandbox.v1.ExtensionService.GetEpisodes:input_type -> sandbox.v1.EntryRequest
	20, // 37: sandbox.v1.ExtensionService.GetVideoStream:input_type -> sandbox.v1.EpisodeRequest
	26, // 38: sandbox.v1.ExtensionService.GetImageBytes:input_type -> sandbox.v1.ImageRequest
	28, // 39: sandbox.v1.ExtensionService.PeekExtension:input_type -> sandbox.v1.PeekExtensionRequest
	34, // 40: sandbox.v1.ExtensionService.GetFilterList:input_type -> sandbox.v1.GetFilterListRequest
	8,  // 41: sandbox.v1.ExtensionService.GetPopularManga:input_type -> sandbox.v1.BrowseRequest
	8,  // 42: sandbox.v1.ExtensionService.GetLatestUpdates:input_type -> sandbox.v1.BrowseRequest
	30, // 43: sandbox.v1.ExtensionService.GetSourcePreferences:input_type -> sandbox.v1.GetSourcePreferencesRequest
	33, // 44: sandbox.v1.ExtensionService.SetSourcePreference:input_type -> sandbox.v1.SetSourcePreferenceRequest
	46, // 45: sandbox.v1.ExtensionService.BrowserCookies:output_type -> sandbox.v1.BrowserCookiesResponse
	6,  // 46: sandbox.v1.ExtensionService.LoadExtensions:output_type -> sandbox.v1.ExtensionList
	6,  // 47: sandbox.v1.ExtensionService.ListLoadedExtensions:output_type -> sandbox.v1.ExtensionList
	1,  // 48: sandbox.v1.ExtensionService.UnloadExtension:output_type -> sandbox.v1.Empty
	9,  // 49: sandbox.v1.ExtensionService.Search:output_type -> sandbox.v1.SearchResponse
	12, // 50: sandbox.v1.ExtensionService.GetDetails:output_type -> sandbox.v1.EntryDetails
	13, // 51: sandbox.v1.ExtensionService.GetChapters:output_type -> sandbox.v1.ChapterList
	16, // 52: sandbox.v1.ExtensionService.GetPages:output_type -> sandbox.v1.PageList
	17, // 53: sandbox.v1.ExtensionService.GetChapterText:output_type -> sandbox.v1.TextContent
	18, // 54: sandbox.v1.ExtensionService.GetEpisodes:output_type -> sandbox.v1.EpisodeList
	21, // 55: sandbox.v1.ExtensionService.GetVideoStream:output_type -> sandbox.v1.StreamInfo
	27, // 56: sandbox.v1.ExtensionService.GetImageBytes:output_type -> sandbox.v1.ImageData
	29, // 57: sandbox.v1.ExtensionService.PeekExtension:output_type -> sandbox.v1.ExtensionMetadata
	35, // 58: sandbox.v1.ExtensionService.GetFilterList:output_type -> sandbox.v1.GetFilterListResponse
	9,  // 59: sandbox.v1.ExtensionService.GetPopularManga:output_type -> sandbox.v1.SearchResponse
	9,  // 60: sandbox.v1.ExtensionService.GetLatestUpdates:output_type -> sandbox.v1.SearchResponse
	32, // 61: sandbox.v1.ExtensionService.GetSourcePreferences:output_type -> sandbox.v1.GetSourcePreferencesResponse
	1,  // 62: sandbox.v1.ExtensionService.SetSourcePreference:output_type -> sandbox.v1.Empty
