...
const (
	ExtensionService_BrowserCookies_FullMethodName       = "/sandbox.v1.ExtensionService/BrowserCookies"
...
type ExtensionServiceClient interface {
	BrowserCookies(ctx context.Context, in *BrowserCookiesRequest, opts ...grpc.CallOption) (*BrowserCookiesResponse, error)
...
func (c *extensionServiceClient) BrowserCookies(ctx context.Context, in *BrowserCookiesRequest, opts ...grpc.CallOption) (*BrowserCookiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BrowserCookiesResponse)
	err := c.cc.Invoke(ctx, ExtensionService_BrowserCookies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExtensionServiceServer interface {
	BrowserCookies(context.Context, *BrowserCookiesRequest) (*BrowserCookiesResponse, error)
...
func (UnimplementedExtensionServiceServer) BrowserCookies(context.Context, *BrowserCookiesRequest) (*BrowserCookiesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BrowserCookies not implemented")
}
func (UnimplementedExtensionServiceServer) LoadExtensions(context.Context, *LoadExtensionsRequest) (*ExtensionList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoadExtensions not implemented")
}
func (UnimplementedExtensionServiceServer) ListLoadedExtensions(context.Context, *Empty) (*ExtensionList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListLoadedExtensions not implemented")
}
func (UnimplementedExtensionServiceServer) UnloadExtension(context.Context, *ExtensionRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnloadExtension not implemented")
}
...
func (UnimplementedExtensionServiceServer) GetChapterText(context.Context, *ChapterRequest) (*TextContent, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetChapterText not implemented")
}
...
func (UnimplementedExtensionServiceServer) GetImageBytes(context.Context, *ImageRequest) (*ImageData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetImageBytes not implemented")
}
func (UnimplementedExtensionServiceServer) PeekExtension(context.Context, *PeekExtensionRequest) (*ExtensionMetadata, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PeekExtension not implemented")
}
...
func (UnimplementedExtensionServiceServer) GetPopularManga(context.Context, *BrowseRequest) (*SearchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPopularManga not implemented")
}
func (UnimplementedExtensionServiceServer) GetLatestUpdates(context.Context, *BrowseRequest) (*SearchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLatestUpdates not implemented")
}
func (UnimplementedExtensionServiceServer) GetSourcePreferences(context.Context, *GetSourcePreferencesRequest) (*GetSourcePreferencesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSourcePreferences not implemented")
}
func (UnimplementedExtensionServiceServer) SetSourcePreference(context.Context, *SetSourcePreferenceRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSourcePreference not implemented")
}
...
func _ExtensionService_BrowserCookies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BrowserCookiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExtensionServiceServer).BrowserCookies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_BrowserCookies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExtensionServiceServer).BrowserCookies(ctx, req.(*BrowserCookiesRequest))
	}
...
var ExtensionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "BrowserCookies",
			Handler:    _ExtensionService_BrowserCookies_Handler,
		},
		{
